...
RUN curl -L https://github.com/protocolbuffers/protobuf/releases/download/v30.1/protoc-30.1-linux-x86_64.zip -o /tmp/protoc.zip
...
RUN curl -L https://go.dev/dl/go1.24.1.linux-amd64.tar.gz -o /tmp/go.tar.gz
