...
require (
	...
	github.com/effective-security/porto v0.33.319
...
require (
	...
	github.com/effective-security/metrics v0.8.91 // indirect
	github.com/effective-security/xpki v0.24.219 // indirect
